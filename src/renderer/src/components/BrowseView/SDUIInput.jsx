...
const SDUIInput = ({ input }) => {
    ...
    return (
        <div
            className='flex flex-col items-center justify-center bg-primary/10 border border-primary/5 rounded-lg px-3 lg:px-6 lg:py-4 py-2 hover:bg-primary/20 cursor-pointer'
