...
import { ChevronDownIcon, ChevronUp, CornerDownRight } from 'lucide-react'
          ...
          <div className="flex items-center">
            <p>
              {device.isMaster && (
                <ChevronUp
                  className={cn(
                    'h-6 w-6 duration-300 cursor-pointer hover:bg-primary/5 rounded-md m-2',
                    isSlaveListOpen && 'rotate-180'
                  )}
                  onClick={() => setIsSlaveListOpen(!isSlaveListOpen)}
                />
              )}
            </p>
            <p>{device.name}</p>
