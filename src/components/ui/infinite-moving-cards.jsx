      ...
      <ul
        ...
        {items.map((item, idx) => {
          ...
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, hsl(var(--primary)/50), hsl(var(--foreground)/50)",
            }}
            key={name}>
            <blockquote>
              <div
              ...
              <span
                className=" relative z-20 text-lg leading-[1.6] text-primary-foreground font-normal">
                {quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  ...
                  <span className=" text-sm leading-[1.6] text-secondary/60 font-normal">
                    {title}
                  </span>
                </span>
              </div>
